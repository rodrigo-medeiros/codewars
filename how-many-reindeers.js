...
// In order to let his reindeers rest a bit, he only takes as many reindeers with him as he is required to do.
...
// As you know, Santa has 8 reindeers in total,
...
function reindeers (presents) {
  ...
  while (presents > 0) {
    presents -= 30;
    required++;
    if (required > total) throw "Can't handle this amount of presents.";
  }
  return required;
}